                ...
                <div class="col-12">
                    ...
                    <form action="{{ route('header.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="m-3">
                                <img src="{{ Storage::url($header->logo) }}" alt="Header Logo">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="secondary_title" value="{{ $header->secondary_title }}"
                                        class="form-control" placeholder="Enter your lastname" id="lastNameinput">
                                </div>
                            </div><!--end col-->
